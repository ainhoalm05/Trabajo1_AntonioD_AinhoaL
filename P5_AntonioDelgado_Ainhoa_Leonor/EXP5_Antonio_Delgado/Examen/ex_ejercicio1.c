...
int main (){
	...
	int adicion=0;//variable para guardar las unidades extra
	inventario[1][1][1][0][9]=200;//le asignamos valor a la dirección pedida en el ejercicio
	printf("\ncantidad a añadir?");
	scanf("%d",&adicion);
	inventario[1][1][1][0][9]+=adicion;//le añadimos las unidades extra introducidas por el usuario
